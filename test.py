import time
import fibmodule.fib as fib # The C extension we built earlier
import fibmodule_asm.fibasm as fibasm  # The C extension we built earlier
...
if __name__ == "__main__":
    n = 40  # Large enough to see differences clearly
